...
public class ErrorMessage {
    ...
    public static final String CANNOT_CONNECT_TO_DB = "Error while trying to connect to Database";
    public static final String CANNOT_CONNECT_TO_API = "Error while connecting to API";
    public static final String INVALID_ID = "The ID provided does not exist";
    public static final String INVALID_DATE = "The Date provided does not exist";
